...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn('bg-primary/[0.04] [&_tr]:border-b', className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      'border-b border-border/70 transition-colors hover:bg-primary/[0.04] data-[state=selected]:bg-primary/[0.08]',
      className,
    )}
    {...props}
  />
